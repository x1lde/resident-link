...
export default function LoginPage() {
    // Next router for redirecting users after auth flows.
    ...
    return (
        <main className="min-h-screen flex items-center justify-center p-6 bg-slate-50 dark:bg-zinc-950">
            <form
                ...
                className="w-full max-w-sm space-y-5 border border-slate-200 dark:border-zinc-800 rounded-xl p-6 bg-white dark:bg-zinc-900 shadow-md transition-all"
            >
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-zinc-400">
                        {mode === "sign-in"
                            ? "Access your resident tracking dashboard ledger"
                            : "Sign up below to join your association community"}
                    </p>
                </div>
                ...
                <div className="space-y-2 pt-1">
                    ...
                    >
                        {mode === "sign-in"
                            ...
                            : "Already have a linked account? Sign in"}
                    </button>
                </div>
            </form>
        </main>
